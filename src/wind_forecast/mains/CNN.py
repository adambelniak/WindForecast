...
from wind_forecast.generators.MultiChannelDataGeneratorWithEarthDeclination import MultiChannelDataGeneratorWithEarthDeclination
from gfs_common.common import plot_history
from wind_forecast.models.CNNModel import create_model
