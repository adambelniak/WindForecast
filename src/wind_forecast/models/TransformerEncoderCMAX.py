...
class TransformerEncoderCMAX(LightningModule):
    ...
    def __init__(self, config: Config):
        ...
        self.conv = nn.Sequential(nn.Conv2d(in_channels=1, out_channels=32, kernel_size=(5, 5)),
                                  nn.ReLU(),
    ...
    def forward(self, inputs, cmax_inputs):
        cmax_embeddings = self.flatten(self.conv_time_distributed(cmax_inputs.unsqueeze(2)))
