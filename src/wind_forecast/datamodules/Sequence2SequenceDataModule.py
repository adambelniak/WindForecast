...
class Sequence2SequenceDataModule(LightningDataModule):
    ...
    def __init__(
        ...
        self.labels, _, _ = prepare_synop_dataset(self.synop_file,
    ...
    def setup(self, stage: Optional[str] = None):
        if stage in (None, 'fit'):
            ...
            self.dataset_test = Sequence2SequenceDataset(config=self.config, synop_data=self.labels, dates=self.dates,
                                                         train=False)
