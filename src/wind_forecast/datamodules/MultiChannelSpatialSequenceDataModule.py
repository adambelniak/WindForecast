...
from wind_forecast.util.gfs_util import get_available_gfs_date_keys, initialize_GFS_date_keys_for_sequence
...
class MultiChannelSpatialSequenceDataModule(LightningDataModule):
    ...
    def __init__(
        ...
        available_ids = get_available_gfs_date_keys(self.train_parameters, self.prediction_offset, self.sequence_length)
        self.IDs = initialize_GFS_date_keys_for_sequence(available_ids, self.labels, self.train_parameters, self.target_param, self.sequence_length)
