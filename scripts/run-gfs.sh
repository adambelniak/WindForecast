...
#experiment.dropout=0.22 optim.base_lr=0.0005 experiment.transformer_ff_dim=256 \
#experiment.transformer_encoder_layers=8 experiment.transformer_decoder_layers=6 \
#experiment.use_time2vec=False experiment.use_value2vec=False experiment.classification_head_dims=[64,128,32] experiment.epochs=20
